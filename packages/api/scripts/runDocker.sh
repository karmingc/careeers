...
(
    docker run  --name pg-careeers-docker -e POSTGRES_PASSWORD=testpassword -e POSTGRES_USER=testuser -e POSTGRES_DB=careeers -d -p 5432:5432 -v $HOME/docker/volumes/careeers:/var/lib/postgresql/data  postgres
)